report 50205 "Facture Proforma CNE 2"
{
    ...
    dataset
    {
        dataitem(DataItem6640; Table36)
        {
            ...
            column(Sales_Header_Advance_Payment_; "Sales Header"."Advance Payment")
            {
            }
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    column(CompanyInfo_AltPicture; CompanyInfo."Alt Picture")
                    {
                    }
                    ...
                    column(CompanyInfo_Alt_Name; CompanyInfo."Alt Name")
                    {
                    }
                    column(Company_Alt_Addr; CompanyInfo."Alt Address" + ' ' + CompanyInfo."Alt Address 2" + ' ' + STRSUBSTNO('%1 %2', CompanyInfo."Alt Post Code", CompanyInfo."Alt City"))
                    {
                    }
                    column(Company_Alt_Tel; STRSUBSTNO(Text066, CompanyInfo."Alt Phone No.", CompanyInfo."Alt Fax No.", CompanyInfo."Alt E-Mail"))
                    {
                    }
                    column(CompanyInfo_Alt_HomePage; CompanyInfo."Alt Home Page")
                    {
                    }
                    ...
                    dataitem(RoundLoop;Table2000000026)
                    {
                        ...
                        column(SalesLine_DEEE_Category_Code;SalesLine."DEEE Category Code")
                        {
                        }
                        column(SalesLine_DEEE_Category_Code_Caption;SalesLine.FIELDCAPTION("DEEE Category Code"))
                        {
                        }
                        column(Item_Number_of_Units_DEEE_;item."Number of Units DEEE")
                        {
                        }
                        column(SalesLine_Quantity_;SalesLine.Quantity)
                        {
                        }
                        column(SalesLine_DEEE_Unit_Price_LCY_;SalesLine."DEEE Unit Price (LCY)")
                        {
                        }
                        ...
                        begin
                            ...
                            RecGDEEETariffs.SETFILTER("Eco Partner",SalesLine."Eco partner DEEE");
                            RecGDEEETariffs.SETFILTER("DEEE Code",SalesLine."DEEE Category Code");
                            IF NOT RecGDEEETariffs.FIND('-') THEN BEGIN
                              RecGDEEE.RESET;
                              RecGDEEE.SETFILTER(RecGDEEE."DEEE Code",SalesLine."DEEE Category Code");
                              RecGDEEE.SETFILTER("Eco Partner",SalesLine."Eco partner DEEE");
                            ...
                            BooGRoundLoopB5:=(SalesLine."DEEE Category Code" <> '') AND
                                                      (SalesLine.Quantity <> 0) AND
                                                        (SalesLine."Eco partner DEEE" <> '');
                            END ELSE BEGIN
                    ...
                    dataitem(VATCounter;Table2000000026)
                    {
                        ...
                        begin
                            ...
                            TmpVATAmount[Number] :=VATAmountLine."VAT Amount" + VATAmountLine."DEEE VAT Amount";
                            //<<TDL:MICO 17/04/2007
                            //                                  PRM fin TVA
                        end;
                    ...
                    dataitem(DataItem1100267002;Table50007)
                    {
            ...
            begin
                ...
                CompanyInfo.CALCFIELDS(CompanyInfo."Alt Picture");
    ...
    var
        ...
        RecGDEEETariffs: Record "50007" temporary;
        "-MICO-": Integer;
        DecGVatDEEE: Decimal;
        BooGSubmittedToDEEE: Boolean;
        RecGCustomerTemplate: Record "5105";
        RecGItem: Record "27";
        Text020: Label 'You have more than 3 VAT (%1) in this order You cannot continue ';
        Text030: Label '%1 - %2 - %3 %4';
        Text031: Label 'Tel. :  %1 ';
        Text100: Label 'Salesperson : ';
        Text101: Label 'Phone :';
        Text200: Label 'Proforma Invoice No. ';
        Text033: Label 'Fax :  %1';
        Text067: Label '%1 STOCK CAPITAL %2  · %3  · Registration No. %4 ·  EP %5';
        Text066: Label 'TEL : %1 FAX : %2 / email : %3';
        CstGTxt001: Label 'Shipment departement';
        CstGTxt002: Label 'Invoice departement';
        CstGTxt003: Label 'VAT No.';
        CstGTxt004: Label 'Invoice Number';
        CstGTxt005: Label 'Date';
        CstGTxt006: Label 'Customer Number';
        CstGTxt007: Label 'Phone ';
        CstGTxt008: Label 'Fax ';
        CstGTxt009: Label 'Reference : ';
        CstGTxt010: Label 'Principal Contact';
        CstGTxt011: Label 'Payment';
        CstGTxt012: Label 'Shipment Mode';
        CstGTxt013: Label 'Payment';
        CstGTxt014: Label ' Item';
        CstGTxt015: Label 'DEEE Contribution : ';
        CstGTxt016: Label 'Item';
        CstGTxt017: Label ' -   Category :';
        CstGTxt018: Label 'Origin';
        CstGTxt019: Label 'TOTAL';
        CstGTxt020: Label 'Discount';
        CstGTxt021: Label 'BASE';
        CstGTxt022: Label 'RATE';
        CstGTxt023: Label 'VAT';
        CstGTxt024: Label 'Total Incl VAT';
        CstGTxt025: Label 'DOWN PAYMENT';
        CstGTxt026: Label 'NET TO BE PAID';
        CstG001: Label 'Representant';
        CstG002: Label 'Unit Sale';
        CstG003: Label 'REGLEMENT DATE';
        CstG004: Label 'REGLEMENT CONDITION';
        CstG005: Label 'Is the total amount is not payed at the due date';
        CstG006: Label 'We will get back the delivered items';
        CstG007: Label 'Late payment : 1,5 legal rate';
