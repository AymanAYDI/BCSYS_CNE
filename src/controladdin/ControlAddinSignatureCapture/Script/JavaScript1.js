...
function InitializeControl(controlId) {
    ...
    ControlId = controlId;   
    var c = $("#" + ControlId);
    var myImg = '<div id="canvas">Canvas is not supported.</div>';
    c.append(myImg);
    zkSignature.capture();
}
...
function loadSignature(base64String)
{
    zkSignature.load(base64String);
}
    ...
    return {
        ...
        clear: function () {
            if (!(empty)) {
                ...
                var parent = document.getElementById(ControlId);
        ...
        load: function (base64String) {
            ...
            var c = $("#" + ControlId);
            var img = '<img class="scan-img" id="myImg" src="data:image/png;base64,' + base64String + '" />';
            c.append(img);
        ...
        send: function () {
            ...
            if (empty == false) {
                ...
                arguments[0] = 1;
                arguments[1] = dataURL;
                Microsoft.Dynamics.NAV.InvokeExtensibilityMethod('SignatureSubmited', arguments);
