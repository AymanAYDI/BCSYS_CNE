page 50098 "Sales Order (MAGASIN)"
{
    // //NAVIDIIGEST   BRRI 01.08.2006 NSC1.00 [Champs_Suppl] Ajout du champ "Advance Payment" sur Onglet Facturation
    // //BON_PREPARION SOBH            NSC1.01 [017]          Ajout des menuItem Bon de preparation, Valider Facture, Valider Livraison
    //                                                        Sur le bouton validation
    // //EMAIL         SOBH            NSC1.01 [005]          Envoi document
    // //CREERDEVISACHAT SM 15/10/06 NCS1.01 [FE04V1] Ajout du bouton créer demande Achat
    // //Demande de pprix
                ...
                action("Order Confirmation")
                {
                    ...
                    begin
                        ...
                        CASE STRMENU (STR3+','+STR4+','+STR5) OF
                              1:DocPrint.PrintSalesOrder(Rec,Usage::"Order Confirmation");
                              2:EnvoiMail;
                        END;
