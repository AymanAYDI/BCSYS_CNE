page 50099 "Purchase Order (MAGASIN)"
{
    // //CONTROLEMINIMA SM 11/10/06 NCS1.01 [FE02] Contrôle Minima MNT
    // //FE005 SEBC 08/01/2007 Add field
    //                         50021 Buy-from Fax No.
    // //FE002.2 SEBC 09/01/2007 : - Add freight port test before printing
    // //CASC NSC1.01 12/01/2007 : Add Field "Advance Payment"
    // //MIG 2017 >>
