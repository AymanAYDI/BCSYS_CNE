pageextension 50013 pageextension50013 extends "Posted Sales Cr. Memo Subform"
{
    ...
    // 
    //  //MODIF JX-XAD du 24/05/2011 Modification des axes analytiques pour document enregistré
    layout
    {
        addafter("Control 70")
        {
    ...
    actions
    {
        ...
        //Unsupported feature: Property Insertion (AccessByPermission) on "Action 1900207104".
    ...
    procedure ReturnRecord(var Prec_SalesCrMemoLine: Record "115")
    begin
