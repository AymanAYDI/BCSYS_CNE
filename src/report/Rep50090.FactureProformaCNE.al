report 50090 "BC6_Facture Proforma CNE"
{
        ...
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                begin
                    ...
                    CalcVATAmountLines(0, SalesHeader, SalesLine, VATAmountLine);
    ...
    var
        ...
        VATRegNoCaptionLbl: Label 'VAT Registration No.', comment = 'FRA="Nø identif. intracomm."';
        GiroNoCaptionLbl: Label 'Giro No.', comment = 'FRA="Nø CCP"';
        BankCaptionLbl: Label 'Bank', comment = 'FRA="Banque"';
        AccountNoCaptionLbl: Label 'Account No.', comment = 'FRA="Nø compte"';
        ...
        GLAccountNoCaptionLbl: Label 'G/L Account No.', comment = 'FRA="Nø compte général"';
        ...
        Text200: Label 'Proforma Invoice No. ', comment = 'FRA="Facture Proforma Nø"';
        Text033: Label 'Fax :  %1';
        ...
        CstGTxt003: Label 'VAT No.', comment = 'FRA="Nø TVA :"';
        CstGTxt004: Label 'Invoice Number', comment = 'FRA="Nø de Facture"';
