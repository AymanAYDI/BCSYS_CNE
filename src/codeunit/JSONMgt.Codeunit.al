codeunit 50041 "JSON Mgt"
{
    ...
    // Mgts10.00.07.00 | 26.07.2022 | Add new function : TryGetValueFromJsonObject
    ...
    [Scope('Internal')]
    procedure TryGetValueFromJsonObject(JsonAsObject: DotNet JObject; "Key": Text; Length: Integer; CurrentValue: Text) Value: Text
    var
        JToken: DotNet JsonToken;
    begin
        IF ISNULL(JsonAsObject) THEN
