tableextension 50005 tableextension50005 extends "Sales Invoice Header"
{
    // ------------------------------------------------------------------------
    ...
    // //SHIPMENT_INVOICED FG 28/02/07 ajout champ 50071
    // //>>CNE1.00
    ...
    fields
    {
        ...
        field(50071;"Shipment Invoiced";Text[250])
        {
    ...
    keys
    {
        ...
        key(Key2;"Document Exchange Status")
        {
        }
        key(Key3;"Prepayment Invoice","Document Exchange Status")
        {
        }
    }
    ...
    //begin
        ...
        DocumentSendingProfile.TrySendToPrinter(
          DummyReportSelections.Usage::"S.Invoice",Rec,"Bill-to Customer No.",ShowRequestForm);
        */
    //end;
