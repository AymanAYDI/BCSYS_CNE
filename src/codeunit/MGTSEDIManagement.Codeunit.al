codeunit 50052 "MGTS EDI Management"
{
    ...
    // 
    // MGTSEDI10.00.00.24 | 28.07.2022 | EDI Management : Add C\AL : GenerateSalesInvoiceVATAndTextEDInfos
    ...
    begin
        ...
        //TVA TEXT
        //>>MGTSEDI10.00.00.24
        IF (SalesInvoiceHeader."Mention Under Total" <> '') THEN BEGIN
            LineNo += 1;
            EDIExportBufferAddInfos.INIT;
            EDIExportBufferAddInfos.Type := EDIExportBufferAddInfos.Type::Text;
            EDIExportBufferAddInfos."Document Enty No." := EDIExportBuffer."Entry No.";
            ...
            EDIExportBufferAddInfos."Text 1" := SalesInvoiceHeader."Mention Under Total";
            EDIExportBufferAddInfos.INSERT;
        END;
