tableextension 50008 tableextension50008 extends "Sales Cr.Memo Line"
{
    // ------------------------------------------------------------------------
    ...
    //           - Add fields 80800..80802 and 80804..80807
    ...
    //Unsupported feature: Property Insertion (Local) on "GetReturnRcptLines(PROCEDURE 4)".
    ...
    //Unsupported feature: Property Deletion (AsVar) on "CalcVATAmountLines(PROCEDURE 2).SalesCrMemoHeader(Parameter 1000)".
