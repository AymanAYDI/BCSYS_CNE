report 50097 "Preparation NAVIDIIGEST1"
{
    // ------------------------------------------------------------------------
    ...
    // //>>MIGRATION NAV 2013
    // 
    // Supprimer var Glob : DocDim1, DocDim2 et DocDimension
    // 
    // ------------------------------------------------------------------------
    // 
    // ------------------------------------------------------------------------
    ...
    // 
    // FEP-ACHAT-200706_18_A.001:LY 13/03/2008 : Achats groupés
    //                                           - Fix length of ModeTransport (Text50 instead of Text30)
    //                                           - Add "Warehouse Comments" on Header
    // ------------------------------------------------------------------------
    DefaultLayout = RDLC;
    RDLCLayout = './PreparationNAVIDIIGEST1.rdlc';
        ...
        dataitem(DataItem6640; Table36)
        {
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    column(CompanyInfo2Picture; CompanyInfo."Alt Picture")
                    {
                    }
                    ...
                    column(CompanyInfo_s_Alt_Picture_; CompanyInfo."Alt Picture")
                    {
                    }
                    ...
                    column(Sales_Header___Warehouse_Comments_; "Sales Header"."Warehouse Comments")
                    {
                    }
                    ...
                    column(Sales_Header___Warehouse_Comments_Caption; "Sales Header".FIELDCAPTION("Warehouse Comments"))
                    {
                    }
