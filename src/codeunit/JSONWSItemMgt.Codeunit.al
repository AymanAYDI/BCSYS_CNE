codeunit 50050 "JSON WS : Item Mgt"
{
    ...
    // 
    // Mgts10.00.07.00 | 26.07.2022 | JSON Business Logic Mgt : Add new C/AL in CreateUpdateItem
    ...
    begin
        WITH Item DO BEGIN
            ...
            //>>Mgts10.00.07.00
            Brand := JsonMgt.TryGetValueFromJsonObject(JsonAsObject, 'Brand', 30, Marque);
            VALIDATE(Marque, Brand);
            //<<Mgts10.00.07.00
