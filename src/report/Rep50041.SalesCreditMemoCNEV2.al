report 50041 "BC6_Sales - Credit Memo CNE V2"
{
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(Loi_N_92_1442_du_31_12_1992_Caption; "Loi_N_92_1442_du_31_12_1992__Escompte_applicale_en_cas_de_paiement_anticipé_Lbl")
                        {
                        }
                        column("L_acheteur_déclare_avoir_pris_connaissance_des_conditions_de_ventes_Caption"; "L_acheteur_déclare_avoir_pris_connaissance_des_conditions_de_ventes_stipulées__laLbl")
                        {
                        }
    ...
    var
        ...
        "L_acheteur_déclare_avoir_pris_connaissance_des_conditions_de_ventes_lLbl": Label 'L''acheteur déclare avoir pris connaissance des conditions de ventes stipulées au verso du présent feuillet  et notamment de la clause de réserve de propriété et les accepter.';
        "L_acheteur_déclare_avoir_pris_connaissance_des_conditions_de_ventes_stipulées__laLbl": Label 'L''acheteur déclare avoir pris connaissance des conditions de ventes stipulées au verso du présent feuillet et notamment de la clause de réserve de propriété et les accepter.';
        ...
        "Loi_N_92_1442_du_31_12_1992__Escompte_applicale_en_cas_de_paiement_anticipé_Lbl": Label 'Loi N°92-1442 du 31/12/1992. Escompte applicale en cas de paiement anticipé = 0.3 % par mois. Retard de paiement : pénalités de 1 % par mois.';
        ...
        VATAmtLineInvDiscBaseAmtCptnLbl: Label 'Invoice Discount Base Amount', Comment = 'FRA="Base TVA"';
