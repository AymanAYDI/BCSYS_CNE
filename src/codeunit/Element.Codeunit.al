codeunit 50021 Element
{
    ...
    // 
    // Support DEL  31/05/202 : Add c\AL
        ...
        CASE element_Re_Loc.Type OF
            ...
            element_Re_Loc.Type::BR:
                BEGIN
                    ...
                    //>>Support DEL
                    IF purchRcptLine_Re_Loc.ISEMPTY AND PurchRcptHeader.GET(element_Re_Loc."Type No.") THEN BEGIN
                        purchRcptLine_Re_Loc.SETRANGE("Document No.");
                        purchRcptLine_Re_Loc.SETRANGE("Order No.", PurchRcptHeader."Order No.");
                    END;
                    //<<Support DEL
