page 50121 "BC6_LOC Purch ReturnOrderList"
{
    ApplicationArea = All;
    ...
    actions
    {
        area(navigation)
        {
            ...
            group(Documents)
            {
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Cred&it Memos', Comment = 'FRA="Expéditions retour"';
                    Image = CreditMemo;
        ...
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    PromotedIsBig = true;
                    PromotedOnly = true;
                    ToolTip = 'Send an approval request.', Comment = 'FRA="Envoyer demande d''approbation"';
                ...
                action(CancelApprovalRequest)
                {
                    ...
                    PromotedIsBig = true;
                    PromotedOnly = true;
                    ToolTip = 'Cancel the approval request.', Comment = 'FRA="Annuler demande d''approbation"';
