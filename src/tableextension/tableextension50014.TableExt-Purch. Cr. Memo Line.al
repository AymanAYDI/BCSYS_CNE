tableextension 50014 tableextension50014 extends "Purch. Cr. Memo Line"
{
    // ------------------------------------------------------------------------
    ...
    // FEP-ADVE-200706_18_E.doc:MA 14/11/2007
    ...
    //Unsupported feature: Property Insertion (Local) on "GetReturnShptLines(PROCEDURE 4)".
    ...
    //Unsupported feature: Property Deletion (AsVar) on "CalcVATAmountLines(PROCEDURE 2).PurchCrMemoHeader(Parameter 1000)".


    //Unsupported feature: Property Modification (Name) on "CalcVATAmountLines(PROCEDURE 2).PurchCrMemoHeader(Parameter 1000)".
    ...
    //Unsupported feature: Property Insertion (Temporary) on "GetItemLedgEntries(PROCEDURE 6).TempItemLedgEntry(Parameter 1000)".
